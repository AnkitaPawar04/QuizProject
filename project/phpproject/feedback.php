...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Information Technology<br><br></span></div>
...
<div class="col-md-2 box">
<!-- <a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About Author</a></div> -->
</div>
</body>
</html>
