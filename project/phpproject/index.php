...
<div class="row">
<div class="col-lg-6">
<span class="logo">Information Technology</span></div>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="Enrollment No"></label>  
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Enrollment no (Ex.2101160***)" class="form-control input-md" type="text" value="<?php
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Information Technology</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Quiz System</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/logo.png" width=150 height=150 alt="Mugunthan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Goernment Polytechnic Thane </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9514444471</h4>
		<h4 style="font-family:'typo' ">gpthane@gmail.com</h4>
